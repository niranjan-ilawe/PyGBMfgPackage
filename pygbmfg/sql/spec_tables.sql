...
INSERT INTO gbmfg.specs (process, pn, data_name, usl, lsl) VALUES
('Kit','1000123','Reads Mapped Confidently to Intronic Regions', 0.39, NULL),
('Kit','1000123','sscrofa111_umi_counts_per_cell_cv', NULL, NULL),
('Kit','1000123','Reads Mapped Confidently to Intergenic Regions', NULL, NULL),
('Kit','1000123','multiplet_rate_per_1000_cells', NULL, NULL),
('Kit','1000123','Fraction Reads in Cells', NULL, 0.80),
('Kit','1000123','Relative difference of detected cells from expected cells', 0.45, -0.45),
('Kit','1000123','Fraction UMI counts for genes >1500nt', NULL, 0.41),
('Kit','1000123','sscrofa111_fraction_reads_in_cells', NULL, NULL),
('Kit','1000123','GRCh38 Median genes per cell (50k raw reads per cell)', NULL, 1397),
('Kit','1000123','sscrofa111_fraction_ribosomal_protein_umi_counts', NULL, NULL),
('Kit','1000123','Valid Barcodes', NULL, 0.95),
('Kit','1000123','grch38_fraction_reads_in_cells', NULL, NULL),
('Kit','1000123','sscrofa111_fraction_mitochondrial_umi_counts', NULL, NULL),
('Kit','1000123','sscrofa111_median_umi_counts_per_cell_50k_raw_reads_per_cell', NULL, NULL),
('Kit','1000123','GRCh38 Median UMI counts per cell (50k raw reads per cell)', NULL, 4378),
('Kit','1000123','sscrofa111_median_genes_per_cell_50k_raw_reads_per_cell', NULL, NULL),
('Kit','1000123','Fraction UMI counts for genes 500-1000nt', NULL, NULL),
('Kit','1000123','GRCh38 Fraction mitochondrial UMI counts', NULL, NULL),
('Kit','1000123','Fraction UMI counts for genes <500nt', NULL, NULL),
('Kit','1000123','Fraction reads with primer or homopolymer sequence', 0.2, NULL),
('Kit','1000123','Reads Mapped Confidently to Transcriptome', NULL, 0.4),
('Kit','1000123','Reads Mapped Confidently to Exonic Regions', NULL, NULL),
('Kit','1000123','mean_umi_count_purity_50k_raw_reads_per_cell', NULL, NULL),
('Kit','1000123','GRCh38 Fraction ribosomal protein UMI counts', NULL, NULL),
('Kit','1000123','GRCh38 UMI counts per cell CV', NULL, NULL),
('Kit','1000123','Fraction reads usable', NULL, 0.32),
('Kit','1000123','cDNA PCR Duplication (50k raw reads per cell)', 0.80, NULL),
('Kit','1000123','Valid UMIs', NULL, 0.99),
('Kit','1000123','Fraction UMI counts for genes 1000-1500nt', NULL, NULL);