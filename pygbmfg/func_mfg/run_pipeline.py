...
#     # get new data from maverick
#     df7 = df_creation_scripts.get_sg_maverick_data(
#         last_modified_date=last_modified_date
#     )

#     try:
#         print("Trying to upload SG Maverick data")
#         db_upload_scripts.upload_data(dfs=df7)
...
#     # get new data for vdj
#     df8 = df_creation_scripts.get_sg_vdj_data(last_modified_date=last_modified_date)

#     try:
#         print("Trying to upload SG VDJ data")
#         db_upload_scripts.upload_data(dfs=df8)
